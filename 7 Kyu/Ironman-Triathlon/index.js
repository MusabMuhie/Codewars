...
function iTri(s){
    //its gonna be a long day!
      if(s==0){
        ...
        return {
          Swim : `${(Math.round((140.6-s) * 100) / 100).toFixed(2)} to go!`
        }
      }else if(s>2.4 && s<=112){
        return {
          Bike : `${(Math.round((140.6-s) * 100) / 100).toFixed(2)} to go!`
        }
      }else if(s>112 && s<130.6){
        return {
          Run : `${(Math.round((140.6-s) * 100) / 100).toFixed(2)} to go!`
        }
