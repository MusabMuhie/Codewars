describe("Basic tests",function(){
  ...
  describe("Random tests", function(){
      ...
      if (marks1 > marks2 && marks1 > marks3) return 'I need to buy a bicycle for my first son.';
      if (marks2 > marks1 && marks2 > marks3) return 'I need to buy a bicycle for my second son.';
      if (marks3 > marks2 && marks3 > marks1) return 'I need to buy a bicycle for my third son.';
      if (marks2 ===  marks1 && marks2 > marks3) return 'I need to buy a bicycle for my second son.';
      ...
      it(`Testing for whoseBicycle`,() => {
        Test.assertSimilar(whoseBicycle(diary1, diary2, diary3), check(diary1, diary2, diary3), "It should work for random tests too");
      })                 
    };
  })